...
@click.option("-sid", "--singularity_image_dir", 
            help="Simgularity/apptainer image directory")
@click.option("--boring",
            help="Dissable fancy logging", is_flag=True)
@click.option("--log-level" ,"-ll", type=click.Choice(["debug", "info", "error", "critical"]), default="info",
            help="Log level")
